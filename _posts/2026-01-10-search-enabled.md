...
image:
  path: /assets/posts/search-enabled/header.png
  alt: "Algolia Search for The Custom Engine Blog"
---

# Search Enabled: Powering The Custom Engine Blog with Algolia

We're excited to announce that **The Custom Engine** blog now features powerful search functionality powered by [Algolia](https://www.algolia.com/)! 
...
*Post written entirely by GitHub Copilot. Have feedback on the search experience? Found a bug? Let us know in the comments below or open an issue on our [GitHub repository](https://github.com/microsoft/mcscatblog).*
