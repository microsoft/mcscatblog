...
Description: This is the analyst role for Snowflake
...
**To obtain the "Sub" ID, generate a token using PowerShell:**
...
**Replace all placeholders with actual values** and execute:
