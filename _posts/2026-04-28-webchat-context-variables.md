...
image:
  ...
  alt: "Header graphic: a Copilot Studio topic screenshot alongside the post title 'How to Set Context Variables to Copilot Studio Agents Using WebChat'"
---
...
_Copilot Studio screenshot of the topic listening for the `customEventSetContext` event_
